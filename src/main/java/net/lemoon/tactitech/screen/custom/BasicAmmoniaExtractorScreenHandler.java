...
public class BasicAmmoniaExtractorScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;
    public final BasicAmmoniaExtractorEntity blockEntity;

    public BasicAmmoniaExtractorScreenHandler(int syncId, PlayerInventory inventory, BlockPos pos) {
...
//        this.addSlot(new Slot(inventory, 0, 8, 62));
    ...
    public int getScaledExtractorProgress() {
        int progress = this.propertyDelegate.get(0);
        int maxProgress = this.propertyDelegate.get(1); // Max Progress
        int extractorPixelSize = 16; // This is the width in pixels of your arrow

        return maxProgress != 0 && progress != 0 ? progress * extractorPixelSize / maxProgress : 0;
    }
